...
#define RFID_CS PBout(5)
#define RFID_RST PBout(9)
//#define LCD_CS	PAout(15)

#define SET_SPI_CS  {RFID_CS = 1;}
#define CLR_SPI_CS  {RFID_CS = 0;}
#define SET_RC522RST  RFID_RST = 1;
#define CLR_RC522RST  RFID_RST = 0;
...
extern uint8_t RFID_DATA_BUF[32];
